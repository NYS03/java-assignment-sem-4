public class globalInventory extends Items{
    ...
    public static Items[] casing = {new casing("K1000", 749, "Lian Li", 1 ,"casing", "Lian Li O11D Evo", "Atx")};

    public static Items[] psu = {new psu("P1000", 899, "Cooler Master", 1, "psu", "Cooler Master Platinum 850W", "ATX", 850)};

    public static Items[] storage = {new storage("S1000", 2000, "Samsung", 1, "storage", "Samsung 980 Pro", "SSD", "2TB")};

    public static Items[] motherboard = {new motherboard("M1000", 2600, "MSI", 1, "motherboard", "MSI TRX40 PRO WIFI", "TR4", "ATX", "DDR4", 256, "2133MHz/4666MHz")};
