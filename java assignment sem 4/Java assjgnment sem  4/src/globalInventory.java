public class globalInventory extends Items{
    public static Items[] cpu = {new cpu("C1000", 1480, "Intel", 1, "Intel i7 9700k","cpu" , 8 , 8, "3.6Ghz/4.9GHz"),
            ...
            new cpu("C1004", 11250, "Intel", 1, "Intel Xeon Platinum 9282 ", "cpu" , 56 , 112, "2.6GHz/3.8GHz"),
            ...
            new cpu("C1012", 30000, "AMD", 1, "Ryzen Threadripper PRO 5995WX", "cpu", 64 , 128, "2.7GHz/4.5GHz")};
